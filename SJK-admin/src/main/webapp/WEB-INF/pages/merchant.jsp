...
<head>
<title>商户管理</title>
    <link rel="stylesheet" href="${path}/css/merchant/merchantPage.css">
    <script src="${path}/js/merchant/merchantPage.js" charset="UTF-8" type="text/javascript"></script>
</head>
<body>
	...
	<div class="panel-body">
		<form id="conForm" class=" form-inline">
  		...
  		<button type="button" onclick="Merchant.searchMerchant()" class="btn btn-info ">
   		...
   		<button type="button" onclick="Merchant.empty()" class="btn btn-danger ">
...
<shiro:hasPermission name="merchantManager:add">
  ...
  <button onclick="Merchant.openDlg()" type="button" class="btn btn-success" style="margin-left: 1015px;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="reset" name="reset" style="display: none;" />
                <button type="button" class="btn btn-default" onclick="Merchant.closeDlg()">关闭</button>
               <button type="button" onclick="Merchant.saveMerchant()" class="btn btn-primary">提交</button>
            </div>
            </form>
            </div>
        </div><!-- /.modal-content -->
...
<div id="updateDlg" class="modal fade" id="myModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="reset" name="reset" style="display: none;" />
                <button type="button" class="btn btn-default" onclick="Merchant.closeDlg()">关闭</button>
               <button type="button" onclick="Merchant.updateMerchant()" class="btn btn-primary">提交</button>
            </div>
            </form>
            </div>
        </div><!-- /.modal-content -->
...
<div id="roleDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="reset" name="reset" style="display: none;" />
                <button type="button" class="btn btn-default" onclick="Merchant.closeDlg()">关闭</button>
               <button type="button" onclick="Merchant.saveRole()" class="btn btn-primary">保存</button>
            </div>
            </form>
            </div>
        </div><!-- /.modal-content -->
